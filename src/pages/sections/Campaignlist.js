      ...
      <table className="flex-1">
        <thead>
          <tr className="h-20 ctm-border-color-3 border-b">
            ...
            <th className="px-4 text-left w-40 ctm-min-width-1 ctm-max-width-2">Title</th>
            <th className="px-4 text-center w-24 ">Influencers</th>
            <th className="px-4 text-center w-32 ctm-min-width-0 ctm-max-width-1">Create Date</th>
            <th className="px-4 text-center w-32 ctm-min-width-0 ctm-max-width-1">Start Date</th>
            <th className="px-4 text-center w-32 ctm-min-width-0 ctm-max-width-1">End Date</th>
            <th className="px-4 text-center w-32 ctm-min-width-0 ctm-max-width-1">Status</th>
          ...
          {campaignList.map((campaign) => {
            return (
              ...
              >
                ...
                <td className="px-4 text-center"></td>
                <td className="ctm-min-width-1 ctm-max-width-2 px-4 w-40 text-left whitespace-nowrap overflow-ellipsis max-w-xs overflow-hidden">
